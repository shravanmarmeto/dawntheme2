...
public class VerifyDetails {
	public static void verifyProductDetailsPDPAjaxCart(HashMap<String, String> pdpProductDetails,
			HashMap<String, String> ajaxcartProductDetails) throws Exception {
	...
	public static void verifyProductDetailsPDPCart(HashMap<String, String> pdpProductDetails,
			HashMap<String, String> cartProductDetails) throws Exception {
